...
function loja_configuracoes_config(){
	global $_GESTOR;
...
function loja_configuracoes_interfaces_padroes(){
	global $_GESTOR;
...
function loja_configuracoes_ajax_opcao(){
	global $_GESTOR;
...
function loja_configuracoes_start(){
	global $_GESTOR;
	...
	if($_GESTOR['ajax']){
		...
		switch($_GESTOR['ajax-opcao']){
			//case 'opcao': loja_configuracoes_ajax_opcao(); break;
		}
		
		interface_ajax_finalizar();
	} else {
		loja_configuracoes_interfaces_padroes();
		
		interface_iniciar();
		
		switch($_GESTOR['opcao']){
			case 'config': loja_configuracoes_config(); break;
		}
