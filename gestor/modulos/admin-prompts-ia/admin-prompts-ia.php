...
$_GESTOR['modulo-id']							=	'admin-prompts-ia';
$_GESTOR['modulo#'.$_GESTOR['modulo-id']] = json_decode(file_get_contents(__DIR__ . '/admin-prompts-ia.json'), true);

// ===== Interfaces Auxiliares

function admin_prompts_ia_interface_auxiliar(){
	
}

// ===== Interfaces Principais

function admin_prompts_ia_adicionar(){
	global $_GESTOR;
	...
	$_GESTOR['javascript'][] = '<script src="https://cdnjs.cloudflare.com/ajax/libs/codemirror/5.65.20/mode/markdown/markdown.js"></script>';
...
function admin_prompts_ia_editar(){
	global $_GESTOR;
...
function admin_prompts_ia_interfaces_padroes(){
	global $_GESTOR;
...
function admin_prompts_ia_ajax_opcao(){
    global $_GESTOR;
...
function admin_prompts_ia_start(){
	global $_GESTOR;
	...
	if($_GESTOR['ajax']){
		...
		switch($_GESTOR['ajax-opcao']){
			case 'opcao': admin_prompts_ia_ajax_opcao(); break;
		}
		...
		switch($_GESTOR['opcao']){
			case 'adicionar': admin_prompts_ia_adicionar(); break;
			case 'editar': admin_prompts_ia_editar(); break;
			case 'opcao': admin_prompts_ia_opcao(); break;
		}
