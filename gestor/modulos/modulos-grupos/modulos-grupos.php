...
$_GESTOR['modulo-id']							=	'modulos-grupos';
$_GESTOR['modulo#'.$_GESTOR['modulo-id']] = json_decode(file_get_contents(__DIR__ . '/modulos-grupos.json'), true);
...
function modulos_grupos_editar(){
	global $_GESTOR;
...
function modulos_grupos_clonar(){
	global $_GESTOR;
...
function modulos_grupos_interfaces_padroes(){
	global $_GESTOR;
...
function modulos_grupos_start(){
	...
	if($_GESTOR['ajax']){
		...
		switch($_GESTOR['ajax-opcao']){
			//case 'opcao': modulos_grupos_ajax_opcao(); break;
		}
		
		interface_ajax_finalizar();
	} else {
		modulos_grupos_interfaces_padroes();
		
		interface_iniciar();
		
		switch($_GESTOR['opcao']){
			case 'adicionar': modulos_grupos_adicionar(); break;
			case 'editar': modulos_grupos_editar(); break;
			case 'clonar': modulos_grupos_clonar(); break;
		}
