...
$_GESTOR['versao']						        = 	'2.10.12'; // Versão do gestor como um todo.
...
$_CONFIG = [
    ...
    'captcha-provider'                   => !empty($_ENV['CAPTCHA_PROVIDER']) ? $_ENV['CAPTCHA_PROVIDER'] : (filter_var($_ENV['USUARIO_RECAPTCHA_ACTIVE'] ?? false, FILTER_VALIDATE_BOOLEAN) ? 'google-recaptcha' : 'none'),
    'turnstile-site-key'                 => $_ENV['TURNSTILE_SITE_KEY'] ?? '',
    'turnstile-secret-key'               => $_ENV['TURNSTILE_SECRET_KEY'] ?? '',
    'turnstile-mode'                     => $_ENV['TURNSTILE_MODE'] ?? 'managed',
