...
final class CreateHostsUsuariosPerfisModulosTable extends AbstractMigration
{
    ...
    {
        $table = $this->table('hosts_usuarios_perfis_modulos', ['id' => false, 'primary_key' => ['id_hosts_usuarios_perfis_modulos']]);
        $table->addColumn('id_hosts_usuarios_perfis_modulos', 'integer')
