...
final class CreateHostsComponentesTable extends AbstractMigration
{
    public function change(): void
    {
        $table = $this->table('hosts_componentes', ['id' => false, 'primary_key' => ['id_hosts_componentes']]);
        $table->addColumn('id_hosts_componentes', 'integer')
