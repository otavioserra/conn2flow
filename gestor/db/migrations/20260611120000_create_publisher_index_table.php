...
/**
 * Tabela do módulo Publicador Índice (publisher-index, req-028 / DEC-041).
 * Espelha a estrutura física de publisher_highlights (com css_compiled e html_extra_head
 * já incorporados), porém com o fields_schema estendido para os controles de exibição
 * (items_per_page, show_search_input, show_sorting_select, show_load_more_btn) gravados
 * dentro do próprio JSON — sem necessidade de colunas dedicadas.
 */
final class CreatePublisherIndexTable extends AbstractMigration
{
    public function change(): void
    {
        $table = $this->table('publisher_index', ['id' => 'id_publisher_index']);
        $table->addColumn('id_usuarios', 'integer', ['null' => true, 'default' => 1])
            ...
            // Template HTML editável do widget: estrutura de repetição de itens com
            // placeholders @[[item#campo]]@ e delimitadores <!-- item < --> ... <!-- item > -->.
            ->addColumn('html', 'text', ['limit' => Phinx\Db\Adapter\MysqlAdapter::TEXT_MEDIUM, 'null' => true])
            // CSS customizado para estilização do widget de índice.
