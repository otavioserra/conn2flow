...
final class CreateHistoricoTable extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('id_usuarios', 'integer', ['null' => true, 'default' => null])
              ...
              ->addColumn('alteracao_txt', 'text', ['limit' => \Phinx\Db\Adapter\MysqlAdapter::TEXT_MEDIUM, 'null' => true])
              ->addColumn('valor_antes', 'text', ['limit' => \Phinx\Db\Adapter\MysqlAdapter::TEXT_MEDIUM, 'null' => true])
              ->addColumn('valor_depois', 'text', ['limit' => \Phinx\Db\Adapter\MysqlAdapter::TEXT_MEDIUM, 'null' => true])
