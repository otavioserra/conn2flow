...
Para fins de otimização de tokens e contexto, requisições antigas (`req-001.md` até `req-093.md`) foram movidas para a pasta histórica **[archive/](file:///c:/Users/otavi/OneDrive/Documentos/GIT/conn2flow/sdd/human-requests/archive/)**.
