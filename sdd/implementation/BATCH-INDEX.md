...
| BATCH-018 | ready-for-intake | Tipo Publicador, Correções no Menus e Módulo de Galerias (req-018) | VALIDATION-CHECKLIST.md#batch-018 | Adição do tipo 'publicador' e correções no menus, mais criação do novo módulo 'galleries' com seleção em lote e reordenação Sortable.js |
