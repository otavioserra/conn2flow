...
| BATCH-016 | ready-for-intake | Hierarquia Multi-nível de Menus e Drag-and-Drop Estilo WordPress (req-016) | VALIDATION-CHECKLIST.md#batch-016 | Suporte a múltiplos tipos de itens (páginas, custom links, cabeçalhos, ações CSS e separadores), lista vertical de itens multiníveis com recuo horizontal Sortable.js e recursão de templates de injeção de widget |
| BATCH-017 | blocked | Brainstorm: Autenticação, 2FA, Social Login e Segurança (planejado) | - | Análise de melhorias do módulo perfil-usuario, 2FA, OAuth (Google/Meta), tokens JWT e estrutura de autenticação monolítica |
