...
| BATCH-018 | ready-for-intake | Tipo de Item Publicador no Módulo de Menus (req-018) | VALIDATION-CHECKLIST.md#batch-018 | Adição do tipo 'publicador' que gera sub-itens filhos de forma dinâmica no widget e simulador, com inputs de seleção de publicador, limite de contagem e ordenação |
