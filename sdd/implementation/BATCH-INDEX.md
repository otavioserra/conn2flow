...
| BATCH-009 | complete | Persistência template_id, preview mapeado, simulação completa, limpeza arrobas (req-010) |
| BATCH-010 | complete | Ordem manual, hidratação selects, vínculo no inserir, simulação diversificada (req-011) | VALIDATION-CHECKLIST.md#batch-010 | 5 itens: jquery-custom-dropdown onAdd/onRemove, setTimeout em #rule/#order_by, força tem_vinculo para highlights, offsets por varName, enriquecer mocks | VALIDATION-CHECKLIST.md#batch-009 | 5 itens: template_id no fields_schema (sem coluna nova), normalizar fields_values do widget, fallbacks robustos simulação, refresh ao trocar template, remover @@ decorativos das 6 páginas |
