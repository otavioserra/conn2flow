...
$_CONFIG['session-authname']					=	'_BSID'; // Nome do cookie de sessão de usuário
...
$_CONFIG['cookie-authname']						=	'_BUSID'; // Nome do cookie de sessão de autenticação de usuário
$_CONFIG['cookie-verify']						=	'_BCVID'; // Nome do cookie de sessão de autenticação de usuário
...
$_CONFIG['email'] = Array(
	'ativo'				=>	true,
	'server'			=>	Array(
		'host'				=>	'beta.b2make.com',
		'user'				=>	'noreply@beta.b2make.com',
		'pass'				=>	'SECRET',
		'secure'			=>	true,
		'port'				=>	465,
	),
	'sender'			=>	Array(
		'from'				=>	'noreply@beta.b2make.com',
		'fromName'			=>	'B2make Beta',
		'replyTo'			=>	'noreply@beta.b2make.com',
		'replyToName'		=>	'B2make Beta',
	),
);
