$(document).ready(function(){
	...
	$(".galeria-excluir-foto").live("click touchstart", function() {
	...
	$("div#categorias-lista ul li").live("click touchstart", function(e) {
	...
	$(".categorias-add").live("click touchstart", function(e) {
		categoria_txt_modo = 'categoria_add';
		$("#categoria-add-txt").val('');
	...
	$(".categorias-editar").live("click touchstart", function(e) {
	...
	$(".categorias-excluir").live("click touchstart", function(e) {
		categoria_id_global = $(this).parent().parent().attr('data-id');
		categoria_objeto = $(this).parent().parent();
		e.stopPropagation();
