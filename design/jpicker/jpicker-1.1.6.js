      ...
      return this.each(
        function()
        {
          ...
          if (settings.window.expandable)
            $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="'+(settings.localization.tooltips.picker_open ? settings.localization.tooltips.picker_open : 'Click To Open Color Picker')+'">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
          ...
          var isLessThanIE7 = parseFloat(navigator.appVersion.split('MSIE')[1]) < 7 && document.body.filters, // needed to run the AlphaImageLoader function for IE6
            ...
            show =
              function()
              {
                ...
                if (settings.window.expandable)
                {
                  $((settings.window.element ? settings.window.element: document.body)).children('div.jPicker.Container').css({zIndex:(settings.window.zIndex ? settings.window.zIndex - 10: 10)});
                  container.css({zIndex:(settings.window.zIndex ? settings.window.zIndex: 20)});
                }
            ...
            hide =
              function()
              {
                var removeIFrame = function()
                  {
                    if (settings.window.expandable) container.css({ zIndex: (settings.window.zIndex ? settings.window.zIndex - 10: 10) });
                    if (!settings.window.expandable || $.support.boxModel) return;
            ...
            initialize =
              function()
              {
                ...
                if (win.expandable)
                {
                  ...
                  if($((settings.window.element ? settings.window.element: document.body)).children('div.jPicker.Container').length==0)$((settings.window.element ? settings.window.element: document.body)).prepend(container);
                  else $((settings.window.element ? settings.window.element: document.body)).children('div.jPicker.Container:last').after(container);
                  container.mousedown(
                    function()
                    {
                      $((settings.window.element ? settings.window.element: document.body)).children('div.jPicker.Container').css({zIndex:(settings.window.zIndex ? settings.window.zIndex - 10: 10)});
