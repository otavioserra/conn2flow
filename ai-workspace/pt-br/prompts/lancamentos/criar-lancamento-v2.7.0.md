# Prompt Interactive Programming - Criar Lançamento - v2.7.0

## 📝 Orientações para o Agente
1. Analise a documentação para você ter o contexto geral do sistema atualmente: `ai-workspace\docs`.
2. Busque por todos os últimos commits no repositório para entender as mudanças recentes para criar o texto principal deste lançamento, bem como seu histórico de mudanças. As versões antes do último lançamento são desde v2.6.0 até a versão atual que será a v2.7.0.
