...
6. Crie uma mensagem de tag e uma de commit detalhada para o lançamento para incluir na próxima etapa.
7. Use o script pronto para fazer as operações necessárias no repositório GIT: `ai-workspace\pt-br\scripts\releases\release.sh` usando o seguinte exemplo: `bash ./ai-workspace/pt-br/scripts/releases/release.sh patch "Resumo para a Tag" "Mensagem detalhada para o Commit"`.
...
- [x] Buscar commits desde v2.7.0 até hoje para entender mudanças recentes
- [x] Atualizar README.md e README-PT-BR.md com informações da v2.7.6
- [x] Atualizar CHANGELOG.md e CHANGELOG-PT-BR.md com entrada da v2.7.6
...
- [x] Criar mensagens de tag e commit para o lançamento
  - **Tag (title):** "Gestor v2.7.6 — Integração PayPal, melhorias em formulários e Docker"
  - **Commit (detailed):** "chore(release): prepara release v2.7.6 — correção de update merge, logs INFO, e ajustes no docker-compose"
- [x] Executar script de release com mensagens criadas (release publicado via workflow / GitHub Actions)
- [x] **RELEASE v2.7.6 CONCLUÍDO COM SUCESSO!** 🎉
