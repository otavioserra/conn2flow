# 📚 Documentação Técnica - Conn2Flow
...
- **[CONN2FLOW-LAYOUTS-PAGINAS-COMPONENTES.md](CONN2FLOW-LAYOUTS-PAGINAS-COMPONENTES.md)** - Layouts, páginas e componentes (estrutura, exportação, versionamento)
- **[CONN2FLOW-SISTEMA-RECURSOS.md](CONN2FLOW-SISTEMA-RECURSOS.md)** - Guia completo sobre o Sistema de Recursos (Global, Módulos, Ferramentas)
- **[CONN2FLOW-MODULOS-DETALHADO.md](CONN2FLOW-MODULOS-DETALHADO.md)** - Desenvolvimento e estrutura de módulos
- **[CONN2FLOW-ROTEAMENTO-DETALHADO.md](CONN2FLOW-ROTEAMENTO-DETALHADO.md)** - Sistema de roteamento detalhado
- **[CONN2FLOW-VARIAVEIS-GLOBAIS.md](CONN2FLOW-VARIAVEIS-GLOBAIS.md)** - Glossário completo de variáveis globais do sistema (@[[FUNCAO#VARIAVEL]]@)
- **[CONN2FLOW-AUTOMACAO-EXPORTACAO.md](CONN2FLOW-AUTOMACAO-EXPORTACAO.md)** - Automação e validação da exportação de recursos
- **[CONN2FLOW-HISTORICO-EXPORTACAO.md](CONN2FLOW-HISTORICO-EXPORTACAO.md)** - Histórico de decisões e aprendizados do ciclo de exportação
...
- **[CONN2FLOW-ATUALIZACOES-SISTEMA.md](CONN2FLOW-ATUALIZACOES-SISTEMA.md)** - Sistema de atualizações automáticas
- **[CONN2FLOW-SISTEMA-PROJETOS.md](CONN2FLOW-SISTEMA-PROJETOS.md)** - Sistema de deploy de projetos via API OAuth
- **[CONN2FLOW-AMBIENTE-DOCKER.md](CONN2FLOW-AMBIENTE-DOCKER.md)** - Ambiente Docker completo de desenvolvimento e testes
- **[CONN2FLOW-GITHUB-ACTIONS.md](CONN2FLOW-GITHUB-ACTIONS.md)** - Sistema completo de automação CI/CD via GitHub Actions
- **[CONN2FLOW-SISTEMA-HIBRIDO-MULTILANGUE-CONCLUIDO.md](CONN2FLOW-SISTEMA-HIBRIDO-MULTILANGUE-CONCLUIDO.md)** - Sistema multilíngue híbrido finalizado
