# Changelog — v2 Legacy Archive (v2.0.21 to v2.8.4)

Historical changelog archive for Conn2Flow v2.x legacy releases.
Current releases are documented in the main [CHANGELOG.md](../../../../CHANGELOG.md).
