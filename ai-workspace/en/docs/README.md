# 📚 Technical Documentation - Conn2Flow

This folder contains all detailed technical documentation of the Conn2Flow project, organized by area/module.
...
- **[CONN2FLOW-LAYOUTS-PAGES-COMPONENTS.md](CONN2FLOW-LAYOUTS-PAGES-COMPONENTS.md)** - Layouts, pages, and components (structure, export, versioning)
- **[CONN2FLOW-RESOURCES-SYSTEM.md](CONN2FLOW-RESOURCES-SYSTEM.md)** - Complete guide on the Resources System (Global, Modules, Tools)
- **[CONN2FLOW-MODULES-DETAILED.md](CONN2FLOW-MODULES-DETAILED.md)** - Module development and structure
- **[CONN2FLOW-ROUTING-DETAILED.md](CONN2FLOW-ROUTING-DETAILED.md)** - Detailed routing system
- **[CONN2FLOW-GLOBAL-VARIABLES.md](CONN2FLOW-GLOBAL-VARIABLES.md)** - Complete glossary of system global variables (@[[FUNCTION#VARIABLE]]@)
- **[CONN2FLOW-EXPORT-AUTOMATION.md](CONN2FLOW-EXPORT-AUTOMATION.md)** - Automation and validation of resource export
- **[CONN2FLOW-EXPORT-HISTORY.md](CONN2FLOW-EXPORT-HISTORY.md)** - History of decisions and learnings from the export cycle
...
- **[CONN2FLOW-SYSTEM-UPDATES.md](CONN2FLOW-SYSTEM-UPDATES.md)** - Automatic update system
- **[CONN2FLOW-PROJECTS-SYSTEM.md](CONN2FLOW-PROJECTS-SYSTEM.md)** - Project deploy system via OAuth API
- **[CONN2FLOW-DOCKER-ENVIRONMENT.md](CONN2FLOW-DOCKER-ENVIRONMENT.md)** - Complete Docker environment for development and testing
- **[CONN2FLOW-GITHUB-ACTIONS.md](CONN2FLOW-GITHUB-ACTIONS.md)** - Complete CI/CD automation system via GitHub Actions
- **[CONN2FLOW-HYBRID-MULTILANGUAGE-SYSTEM-COMPLETED.md](CONN2FLOW-HYBRID-MULTILANGUAGE-SYSTEM-COMPLETED.md)** - Finished hybrid multilingual system
- **[CONN2FLOW-HYBRID-MULTILANGUAGE-SYSTEM.md](CONN2FLOW-HYBRID-MULTILANGUAGE-SYSTEM.md)** - Documentation of the hybrid multilingual system

### 💳 Payment Integrations
- **[PAYPAL-LIBRARY-V2.md](libraries/PAYPAL-LIBRARY-V2.md)** - Complete PayPal APIs v2 integration (Orders, Subscriptions, Invoicing, etc)
