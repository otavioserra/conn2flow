...
- ✅ **Smooth CSS Transitions**: Fluid animations with animation-free initialization to avoid flashes
- ✅ **Mobile Overlay with Backdrop**: Dark background when mobile/tablet menu is open
- ✅ **Menu State Persistence**: Width and closed state saved in localStorage
- ✅ **Double-Click to Reset**: Double-click on resize handle resets default width (250px)

**Breaking Changes:**
- Mobile/tablet behavior breakpoint changed from 770px to 1024px
- Menu now uses sidebar overlay on tablets (previously used fixed menu)
- New CSS class structure for menu state control

### **gestor-v2.6.0** (December 18, 2025)
**🎯 Theme:** Publisher Module + Quill Editor + Cloning + Image Picker**
...
- ✅ **Dynamic Fields System**: Configurable dynamic fields for templates with various types (text, textarea, image, etc.)
- ✅ **News Abstract Templates**: Ready-to-use templates generated by AI and reviewed
- ✅ **Cloning Functionality**: Quick clone for admin pages, admin templates, and publisher pages
- ✅ **Image Picker in HTML Editor**: Visual image selector integrated with editor with grid preview
- ✅ **Design Simulation Mode**: Dropdown to simulate different design modes in HTML editor
- ✅ **Editor Button Tooltips**: Informative tooltips on template and field buttons
- ✅ **Section Modification in Editor**: Advanced visual section modification capabilities
- ✅ **Fomantic-UI v2.9.4**: Update to latest CSS framework version
- ✅ **Updated Gemini Models**: Updated model versions in AI prompts
- ✅ **Enhanced Language Detection**: Browser detection priority over system default
- ✅ **Multiple Modal System**: Stacked modals support with `allowMultiple: true`
- ✅ **Global Variables Glossary**: Variable documentation for AI components

**Breaking Changes:**
- New publisher module requires database migrations
- Fomantic-UI 'empty' fields migrated to 'notEmpty'
- Multiple modal system implemented
