---
title: "CLI: Assets"
description: "c2f assets commands, arguments and options declared in source code."
section: reference
order: 30
sources:
...
The `assets:*` family has 4 command(s) registered in Application.php.
...
Source: `cli/src/Commands/AssetsFontsCommand.php`.
...
Source: `cli/src/Commands/AssetsMinifyCommand.php`.
...
Source: `cli/src/Commands/AssetsPublishCommand.php`.
...
Source: `cli/src/Commands/AssetsVendorCommand.php`.
