#!/bin/bash
# Safe synchronization script for the manager to the Docker environment
# Copies only new or modified files, never deletes anything from the source
# Usage: bash ./ai-workspace/scripts/dev-environment/synchronize-manager.sh checksum
#
# Source:   gestor/
...
#
# Usage:
#   bash ./ai-workspace/scripts/dev-environment/synchronize-manager.sh [default|checksum|force]
#
