```markdown
# List of PT-BR Resources for Translation
...
*Last update: 09/25/2025 09:47:34*
...
### 🧩 Module Resources  
Location: `gestor/modulos/{module-id}/resources/`

## 📋 Complete List of Files

### 📄 HTML Files (125 files)
- [x] `gestor/resources/en/components/botao-superior-interface/botao-superior-interface.html`
...
- [x] `gestor/resources/en/layouts/layout-administrativo-do-gestor/layout-administrativo-do-gestor.html`
...
- [x] `gestor/modulos/admin-paginas/resources/en/pages/admin-paginas/admin-paginas.html`
...
- [x] `gestor/modulos/perfil-usuario/resources/en/pages/cadastrar-no-sistema/cadastrar-no-sistema.html`
...
- [x] `gestor/modulos/admin-environment/resources/en/pages/admin-environment/admin-environment.css`
...
### ✅ Completed  
All 161 files have been processed. Files containing Portuguese text were translated to English, preserving all variables (@[[...]]@, #...#). Files containing only variables or already in English were marked as completed without changes.

### ❌ With Problems
No problems identified yet.

## 📝 Observations
- List automatically generated by script `verificar-recursos.sh`
- File updated on: 09/25/2025 10:15:00
- To update this list, run: `bash ai-workspace/scripts/translates/verificar-recursos.sh`

---
*Automatically generated on: 09/25/2025 10:15:00*
```