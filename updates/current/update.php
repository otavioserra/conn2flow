...
function config_local_options(){
	...
	(
		...
		"WHERE status='A'"
		." AND grupo='store'"
		." AND variavel='installed'"
	);
	
	if(!$resultado){
		$b2make = connect_b2make(Array(
			'interface' => 'configs.php',
		));
		
		$loja = simpleXmlToArray($b2make->loja);
		
		if($loja)
		foreach($loja as $campo => $valor){
			switch($campo){
				case 'nome':
				case 'endereco':
				case 'complemento':
			...
			$campo_nome = "grupo"; $campo_valor = 'store'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
			$campo_nome = "variavel"; $campo_valor = $campo; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
		...
		$campo_nome = "grupo"; $campo_valor = 'store'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
		$campo_nome = "variavel"; $campo_valor = 'installed'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
		$campo_nome = "valor"; $campo_valor = 'true'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
		$campo_nome = "tipo"; $campo_valor = 'string'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
		$campo_nome = "status"; $campo_valor = 'A'; 		$campos[] = Array($campo_nome,$campo_valor,$campo_sem_aspas_simples);
