...
/*################################################### B2make ###################################################*/
$b2make = $_SESSION["b2make-tinymce-filemanager"];
$b2make['ftp-files-path'] = 'images-library';
/*################################################### B2make ###################################################*/
...
$config = array(
	...
	*/
	...
	'base_url' => $b2make['url-files'].$b2make['ftp-files-path'],
	...
	*/
	...
	|
	*/
	'ftp_host'         => ($b2make['ftp-files-host'] ? $b2make['ftp-files-host'] : 'https://platform.b2make.com'), //put the FTP host
	'ftp_user'         => $b2make['ftp-files-user'],
	'ftp_pass'         => $b2make['ftp-files-pass'],
	'ftp_base_folder'  => $b2make['ftp-files-path'],
	'ftp_base_url'     => $b2make['url-files'] . $b2make['ftp-files-path'],
