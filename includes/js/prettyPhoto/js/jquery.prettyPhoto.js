        ...
        pp_settings = jQuery.extend({
            ...
            markup: '<div class="pp_pic_holder"> \
						...
						<div class="pp_top"> \
							...
							<div class="pp_right"><a class="pp_close" href="#" style="z-index:2000;">Close</a></div> \
						</div> \
            ...
            image_markup: '<img id="fullResImage" src="{path}" /><a class="pp_download" href="{path}" target="_blank"></a>',
            ...
            twitter: false, /* Show twitter "follow" button */
            facebook: false, /* Show facebook "like" button */
        ...
        */
        function _changeTwitter() {
            if (settings.twitter) {
				var title = pp_titles[set_position].replace(/'/g, "\"");
                var link = _getCurrentPictureLink();
                $('.pp_social .twitter').html('<a href="http://twitter.com/share" class="twitter-share-button" data-count="none" data-url="'+link+'" data-text="'+title+'">Tweet</a><script type="text/javascript" src="http://platform.twitter.com/widgets.js"></script>');
            }
        };
