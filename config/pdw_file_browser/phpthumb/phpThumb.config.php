...
$PHPTHUMB_CONFIG['cache_directory'] = MINIFY_CACHE_DIR;                            // set the cache directory relative to the phpThumb() installation
...
$PHPTHUMB_CONFIG['cache_source_directory'] = MINIFY_CACHE_DIR.'/source/';  // set the cache directory for unprocessed source images
