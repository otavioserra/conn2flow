...
1. **Download the Installer**
   ...
   **Direct Download:**
   - Click in the next link to download the `instalador.zip`: [Download Installer v1.4.2](https://github.com/otavioserra/conn2flow/releases/download/instalador-v1.4.2/instalador.zip)
