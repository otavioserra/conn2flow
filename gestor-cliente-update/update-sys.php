...
CREATE TABLE IF NOT EXISTS `modulos` (
  ...
  `id_modulos_grupos` INT NULL DEFAULT NULL,
  `nome` VARCHAR(255) NULL DEFAULT NULL,
  `id` VARCHAR(255) NULL DEFAULT NULL,
  `titulo` VARCHAR(255) NULL DEFAULT NULL,
  `icone` VARCHAR(100) NULL DEFAULT NULL,
  `icone2` VARCHAR(100) NULL DEFAULT NULL,
  `nao_menu_principal` TINYINT NULL DEFAULT NULL,
  `plugin` VARCHAR(255) NULL DEFAULT NULL,
  `status` CHAR(1) NULL DEFAULT NULL,
  `versao` INT NULL DEFAULT NULL,
  `data_criacao` DATETIME NULL DEFAULT NULL,
  `data_modificacao` DATETIME NULL DEFAULT NULL,
